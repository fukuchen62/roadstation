...
{{-- <!-- g-nav mobile -->
    <nav id="wrapper">
        <h1 class="site-logo mobile-logo"><a href="index.html"><img src="../assets/images/site_logo/logo.png"
                    alt="とくしままるっと道の駅"></a></h1>
            ...
            <ul class="hamburger-menu">
                ...
                <li>
                    <a href="../html/like.html">
                        ...
                        <img src=".{{ asset('assets/images/menu_icon/like_icon.png') }}" alt=""
                            width="30" height="30">
    ...
    <!-- g-nav pc -->
    <nav id="menu" class="nav-pc">
        <h1><a href="index.html"><img src="{{ asset('assets/images/site_logo/logo.png') }}" width="95"
                    height="95" alt="とくしままるっと道の駅"></a></h1>
