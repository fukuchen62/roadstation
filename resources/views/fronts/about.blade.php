...
@section('content')
    ...
    <section>
        ...
        <p>徳島県には魅力的なスポットがたくさんありますが、なかでも、より生活に密着して気軽に楽しめ、県内全域を網羅した「道の駅」の情報は役立ち、生活を豊かにするお手伝いができるのではないかと思い今回『とくしま　まるっと道の駅』のサイトを企画しました。
        </p>
    </section><br>
    <section>
        <h2>サイト制作にご協力くださった方々</h2><br>
        <p>この度は本サイト制作に際して、ご協力いただき誠にありがとうございます。</p>
        <p>徳島全18か所道の駅の皆様</p>
    </section>
    <section>
        <h2>参考サイト</h2><br>
        ...
        <a href="https://www.awanavi.jp/" class="link">
            <p>阿波ナビ</p>
        </a><br>
        <a href="https://www.michi-no-eki.jp/" class="link">
            <p>全国道の駅公式ホームページ</p>
        </a>
        <br>
    </section>
    <section>
        <h2>このサイトの使い方</h2><br><br>
        <h3>道の駅を探す</h3><br>
        <p>徳島県の道の駅を一覧から検索できます。徳島県の東部・西部・南部といったエリアで探したり、詳細な条件からご要望を満たした道の駅を探すこともできます。また、気になる道の駅をお気に入り登録すれば、マイページからいつでも確認することができます。（ログイン不要）
        </p><br>
        ...
        <p>徳島県が全国に誇る食や特産品を紹介しています。実際に道の駅のスタッフの方々にインタビューして、リアルに求められているものを調べてきました。県外の方はもちろん、県内の方も、普段、身近にありすぎて忘れている徳島の良さを再確認したり、お土産探しの手がかりになるかもしれません。
        </p><br>

        <h3>アクティビティを探す</h3><br>
        <p>徳島県の道の駅で体験できるアクティビティを紹介しています。概要や利用条件、実際に行ってみないとわからない体験談などを詳しく利用者の目線でレビューしています。</p><br><br>
    </section>
