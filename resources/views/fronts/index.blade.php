...
<section class="news-box">
    ...
    <ul class="article-list">
        ...
        <ul>
            ...
            @endphp
            <li>
                <a href="{{ url('news-detail') }}?id={{ $news->id }}&news_category_id={{ $news->news_category_id }}&memo={{ $news->memo }}">
...
<section>
    ...
    <div class="goods-wrapper">
        <ul class="goods">
            ...
            <li><img class="image-tile" src="{{ asset('assets/images/index/narutokintoki.png') }}" alt="鳴門金時">
            </li>
