...
<section class="activity-delimiter">
    <div class="activity-group">
        ...
        <div class="activity-text-group">
            ...
            <p class="station-name"><a href="{{ url('station-detail') }}?id={{ $activity->roadStation->getId() }}">{{ $activity->roadstation->getName() }}</a>
            </p>
    ...
    @else
    <ul>
        <li class="roadstation-frame"><a href="{{ url('blog-detail') }}?id={{ $activity->blog->id }}&category_id={{ $activity->blog->categoryy_id }}">{{ $activity->blog->getName() }}</a>
        </li>
    </ul>
    @endif --}}
